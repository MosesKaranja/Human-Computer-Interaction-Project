...
/*Cookie ID is in the config.php*/
			...
			<table class="table table-bordered table-condensed table-striped">
				...
				<tbody>
					...
					foreach($items as $item){
						...
						<tr>
							<td><?= $i;?>
								<a href="cart.php?delete=<?= $i;?>" class="btn btn-xs btn-default"><span class="glyphicon glyphicon-remove-sign"></span></a>
							</td>
							<td><?= $product['title'];?></td>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
      	...
      	<form action="thankyou.php" method="post" id="payment-form">
      		...
      		<input type="hidden" name="description" value="<?= $item_count. ' item'. (($item_count > 1)? 's' : ''). 'from Murugu Herbal Clinic'; ?>">
...
<script>
	...
	function check_address(){
		...
		jQuery.ajax({
			url : '/shantel/admin/parsers/check_address.php',
			method : 'POST',
			data : data,
